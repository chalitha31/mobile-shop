...
<head>
    <title>FutureTech | Invoice</title>
...
<body class="mt-5" style="background-color: #f7f7ff;">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 btn-toolbar justify-content-end">
                ...
                <button class="btn btn-dark me-2">Print</button>
                    ...
                    <div class="col-6">
                        <div class="row">
                            ...
                            <div class="col-12 text-end fw-bold">
                                ...
                                <span>FutureTech@gmail.com</span>
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end border-primary">Rs.
                                        ...
                                        if ($order_data["total"] > "250000") {
                                            ...
                                            echo $discount;
                                        } else if ($order_data["total"] <= "250000") {
                                ...
                                <tr>
                                    ...
                                    <td class="text-end border-primary text-primary fs-5 fw-bold">Rs. <?php echo $order_data["total"] - $discount  ?>
                                        <?php
                                        if (is_int($discount)) {
                                        ?>
                                            .00
