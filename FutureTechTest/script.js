...
document.addEventListener('click', (event) => {
    if (!loginForm.contains(event.target) && !event.target.matches('#user-btn')) {
...
//     };
// } else {
//     console.error('#user-btn element not found');
// }
...
window.onload = function() {
    ...
    new Typed(".auto-type", {
        ...
        strings: ["Future Tech", "Cell Phone and Accessries", "computer and Tablets", "Cameras", "Mouse and Keyboard", "Mobile Back Covers"],
    ...
    r.onreadystatechange = function() {
        if (r.readyState == 4) {
            ...
            if (t == "Please Sign in first.") {
                alert(t);
                window.location = "http://localhost/FutureTechTest/index.php";
