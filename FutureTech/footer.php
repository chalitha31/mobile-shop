        ...
        <div class="col-12 text-md-start">
            <div class="row text-sm-center text-md-start">
                ...
                <div class="col-12 col-md-3 col-lg-3 mx-auto mt-3">
                    ...
                    <p>Here we are the theMobileshop.lk&trade; to support you for accomplish your dessire by selling high
                        quality products.</p>
                </div>

                <div class="col-12 col-md-3 col-lg-2 mx-auto mt-3">
                    <p>Copyright &copy;2021 theMshop All Rights Reserved</p>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3 mx-auto mt-3">
                    ...
                    <p><i class="bi bi-envelope-fill"></i> theMobileshop@gmail.com</p>
                ...
                <div class="col-12  mt-4">
                    <div class="row p-4">
                        <div class="col-12 col-lg-6 lastd p-3">
                            <h5 class="text-black">Sign up for Newsletter ...and get offers and updates to your inbox</h5>
                            <div class="input-group p-2 ">
                                ...
                                <button class="btn btn-primary text-white" type="button" id="button-addon2">Sign Up</button>
                            </div>
                        </div>
