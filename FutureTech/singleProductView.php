        ...
        <body style="overflow-x: hidden;">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5 singlproduct">
                                                            ...
                                                            <div class="row">
                                                                <div class="border border-1 border-secondary rounded overflow-hidden float-start mt-1 position-relative product_qty">
                                                                    <div class="col-12">
                                                                        ...
                                                                        if ($cartval == 0) {
                                                                        ?>
                                                                            <input id="qtyinput<?php echo $pid ?>" type="number" style="outline:none;" class="border-0 fs-6 fw-bold text-start qty" min="0" value="1" onkeyup='check_val(<?php echo $pd["qty"] ?>,<?php echo $pid; ?>)' />
                                                                        <?php
                                                                        } else {
                                                                        ?>
                                                                            <input id="qtyinput<?php echo $pid ?>" type="number" style="outline:none;" class="border-0 fs-6 fw-bold text-start qty" min="0" value="<?php echo $cartdi["qty"] ?>" onkeyup='check_val(<?php echo $pd["qty"] ?>,<?php echo $pid; ?>)' />
                                                                        <?php
                                                                        }
                                                                ...
                                                                <div class="col-12 mt-3">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-4 col-lg-5 d-grid">
                                                                            <button class="btn btn-success" onclick="buyProduct(<?php echo $pid; ?>);"> Buy Now</button>
                                                                        </div>
                                                                        <div class="col-4 col-lg-2 d-grid">
                                                                            <?php
                                                                            $watchrs = Database::search("SELECT * FROM `watchlist` WHERE `product_id` = '" . $pid . "' AND `user_email` = '" . $_SESSION["u"]["email"] . "' ");
                                                                            $num = $watchrs->num_rows;
                                                                            if ($num == 1) {
                                                                            ?>
                                                                            ...
                                                                            ?>
                                                                                <button class="btn btn-secondary" onclick='addToWatchlist("<?php echo $pid ?>");'>
                                                                                    <i class="fas fa-heart fs-4 mt-1" id="heart<?php echo $pid; ?>"></i>
                                                                                </button>
                                                                            <?php
                                                                            }
                                                                            ?>
