                    ...
                    <div class="row ">
                        ...
                        <div class="col-2 col-lg-5 dropdown d-none d-lg-block d-md-block">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                <li><a class="dropdown-item" href="http://localhost/FutureTech/userprofile.php">My Profile</a></li> -->
                <!-- <li><a class="dropdown-item" href="#">My Sellings</a></li> -->
                <!-- <li><a class="dropdown-item" href="http://localhost/FutureTech/myProducts.php">My Products</a></li>
                                <li><a class="dropdown-item" href="http://localhost/FutureTech/watchlist.php">Wish List</a></li> -->
                <!-- <li><a class="dropdown-item" href="#">Purchase History</a></li> -->
                <!-- <li><a class="dropdown-item" href="#">Messages</a></li> -->
                <!-- <li><a class="dropdown-item" href="http://localhost/FutureTech/addproduct.php">Add Product</a></li> -->
                <!-- </ul>
                        </div>

                        <div class="col-1 text-white col-lg-1 ms-2 ms-lg-0 mt-1 fs-4">
                            <a href=" http://localhost/FutureTech/cart.php"><i class="bi bi-cart-plus"></i></a>
