                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="card-body mt-4">
                                ...
                                <h5 class="card-title text-black fw-bold fs-4"><?php echo $ps["title"]; ?></h5>
                                <span class="card-text text-primary fw-bold fs-4">Rs :- <?php echo $ps["price"]; ?>.00</span>
                                <br />
                                <span class="card-text text-success fw-bold fs-4"><?php echo $ps["qty"]; ?> Items Left</span>

                                <div class="row">
                                    <div class="col-12">

                                        <div class="row g-1">
                                            <div class="col-12  col-lg-4 mt-2 d-grid">
                                                <a href='<?php echo "singleProductView.php?id=" . ($ps["id"]) ?>' class="btn btn-success fs-4 ">Buy Now</a>
                                            </div>
                                            <div class="col-12 col-lg-4 mt-2 d-grid">
                                                <a href="#" onclick="addToCart(<?php echo $ps['id']; ?>);" class="btn btn-danger fs-4 ">Add Cart</a>
                                            </div>
                                            <div class="col-12 col-lg-3 ">
                                                ...
                                                ?>
                                                        ...
                                                        <a onclick='addToWatchlist("<?php echo $ps["id"]; ?>");' class="btn btn-secondary col-12 mt-1" style="background-color: #097fec;" id="heart<?php echo $ps["id"]; ?>"><i class="bi bi-heart-half fs-4"></i></a>
                                                    ...
                                                    ?>
                                                        ...
                                                        <a onclick='addToWatchlist("<?php echo $ps["id"]; ?>");' class="btn btn-secondary col-12 mt-1" id="heart<?php echo $ps["id"]; ?>"><i class="bi bi-heart-half fs-4"></i></a>
                                                    ...
                                                    <a onclick="Watchlist();" class="btn btn-secondary col-12 mt-1"><i class="bi bi-heart-half fs-4"></i></a>
            ...
            <div class="pagination">
                ...
                ?>
                    ...
                    ?>
                        ...
                        <a class="text-black" onclick="advancedsearch('<?php echo $page; ?>');"><?php echo $page; ?></a>
