...
$rs = Database::search("SELECT * FROM `brand` WHERE `name` LIKE '%" . $new_category . "%' ");
$rsn = $rs->num_rows;
if ($rsn == 0) {
    ...
    $mail->isHTML(true);
    $mail->Subject = 'theMobileShop brand Verification Code';
    ...
    echo "A Similar brand Already Exists";
}
