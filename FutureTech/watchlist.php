...
<head>
    ...
    <title>The Mobile sHop | Watchlist</title>
                            ...
                            <div class="row">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 col-lg-9">
                                        <div class="row">
                                            <div class="col-12 emptywatchview"></div>
                                                        ...
                                                        <div class="row g-0">
                                                            ...
                                                            <div class="col-md-3 mt-4">
                                                                <div class="card-body d-grid">
                                                                    <a href='<?php echo "singleProductView.php?id=" . ($pf["id"]) ?>' class="btn btn-outline-success mb-2">Buy now</a>
                                                                    <a href="#" onclick="addToCart(<?php echo $pf['id']; ?>);" class="btn btn-outline-warning mb-2">Add Cart</a>
